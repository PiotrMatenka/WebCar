...
public class UserDAOImpl implements UserDAO {
    private static final String CREATE_USER = "INSERT INTO user(username, email, password, city, is_active) VALUES (:username, :email, :password, :city, :active); ";
    private static final String READ_USER = "SELECT user_id, username, email, password, city, is_active FROM user WHERE user_id= :id;";
    private static final String READ_USER_BY_NAME ="SELECT user_id, username, email, password, city, is_active FROM user WHERE username= :username;";
    ...
    public User getUserByUsername(String username) {
        ...
        resultUser = template.queryForObject(READ_USER_BY_NAME, paramSource, new UserRowMapper());
        return resultUser;
    }
